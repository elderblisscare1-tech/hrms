...
const navItems = [
  ...
  { label: "Daily Attendance", href: "/super-admin/attendance/daily", icon: Clock },
  { label: "Leave", href: "/super-admin/leave", icon: CalendarOff },
  { label: "Payroll", href: "/super-admin/payroll", icon: Wallet },
  { label: "Reports", href: "/super-admin/reports", icon: BarChart3 },
  { label: "Helpdesk", href: "/super-admin/helpdesk", icon: TicketCheck },
  { label: "Leads", href: "/super-admin/leads", icon: Target },
  { label: "Roles", href: "/super-admin/roles", icon: Shield },
  { label: "EBC Dutys", href: "/super-admin/ebc-dutys", icon: ClipboardList },
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <div className="animate-fade-in flex-1 truncate">
            <h1 className="font-bold text-base text-white truncate">{companySettings?.name || "Super Admin"}</h1>
            <p className="text-[10px] text-red-200 uppercase tracking-widest truncate">Portal</p>
          </div>
        )}
      </div>
