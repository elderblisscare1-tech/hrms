...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    try {
      ...
      let canAccessAdmin = role === "hr_admin" || role === "super_admin" || role === "admin";
  ...
  return (
    <div className="animate-fade-in">
      ...
      <h2 className="text-2xl font-bold mb-1">Employee Portal</h2>
      <p className="text-[hsl(var(--muted-foreground))] mb-8">Sign in to your employee account</p>
