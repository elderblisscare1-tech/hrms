...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const [empData, deptData, leaveData, ...attResults] = await Promise.all([
  ...
  const presentTodayCount = attendance.filter(a => a.status === "present" || a.status === "late").length;
  ...
  const dynamicRecentHires = [...employees]
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">{greeting}, Super Admin 👋</h1>
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Link href="/super-admin/attendance">
              <Button variant="ghost" size="sm" className="text-[hsl(var(--primary))]">
